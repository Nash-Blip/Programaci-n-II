...
La aplicación también es capaz de registrar estadísticas sobre el uso y rendimiento de cada vehículo, permitiendo generar un reporte con los autos más alquilados, los más y menos rentables y el porcentaje de vehículos alquilados.

Resumiendo, la aplicación permite:
...
6) Estadísticas de uso y rentabilidad
